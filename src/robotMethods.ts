...
export function findClosestRobotAndDistance (
  robotList: RobotInfo[],
  toFind: LoadInfo): ClosestRobotInfo {
  let closestRobot: RobotInfo = robotList[0] // Dummy value to get through for loop at bottom TODO: something elegant
